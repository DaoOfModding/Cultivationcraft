...
public class QiSourceConfig
{
    ...
    public final static int rarity = 250;
    public final static int MaxOutput = 100000;
    public final static int MinOutput = 1000;
    ...
    public static int generateRandomQiOutput()
    {
        return (int)(Math.pow(Math.random(), 10) * (MaxOutput - MinOutput)) + MinOutput;
    }
}
